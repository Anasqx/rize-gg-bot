...
client.on(Events.MessageCreate,m=>{if(ready&&m.guildId===env.GUILD_ID&&!m.author.bot&&!m.webhookId)enqueue(()=>rewards.activity(m.author.id,'chat')).catch(log);});
